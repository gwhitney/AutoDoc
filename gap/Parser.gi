            ...
            if filter_string <> false then
                ...
                if not IsBound( current_item!.arguments ) then
                    if IsInt( has_filters ) then
                        ...
                        if IsBound( current_item!.initial_args ) and
                           Length( SplitString( current_item!.initial_args, "," ) ) =
                           Length( current_item!.arguments ) then
                            current_item!.arguments := current_item!.initial_args;
                        elif Length( current_item!.arguments ) = 1 then
                            current_item!.arguments := "arg";
                        else
